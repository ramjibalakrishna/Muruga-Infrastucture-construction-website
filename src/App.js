...
import EmployeeSalary from "./EmployeeCrud";
function ram() {
  return (
    <body>
        <Router>
        ...
        <Link to="/EmployeeDetail" class="nav">Employee Detail</Link>
        ...
        {/* <img id="applogo" src="logo.jpg" alt=""></img> */}
          ...
          <Routes>
            <Route>
              ...
              <Route path="EmployeeDetail" element={<EmployeeSalary></EmployeeSalary>}></Route>
            </Route>
          </Routes>
        </Router>
        <div id="footer">
